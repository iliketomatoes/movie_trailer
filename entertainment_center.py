...
ghostbusters = media.Movie(
    "Ghostbusters",
    "https://upload.wikimedia.org/wikipedia/en/thumb/c/c7/Ghostbusters_cover.png/220px-Ghostbusters_cover.png",  # noqa
...
movies = [
    forrest_gump, life_is_beautiful, back_to_the_future,
    ghostbusters, inglorious_basterds, mediterraneo]
